...
export class SeedInitialSchema1759958275364 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`slc_tools_catalog\` (\`id\` int NOT NULL AUTO_INCREMENT, \`catalog_type\` varchar(255) NOT NULL, \`platform_name\` varchar(255) NOT NULL, \`url\` varchar(255) NOT NULL, \`description\` text NULL, \`license\` varchar(255) NULL, \`interface\` varchar(255) NULL, \`keywords\` varchar(255) NULL, \`contact_email\` varchar(255) NULL, \`lti_credentials\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`;
    );
    await queryRunner.query(
