...
export class OptionalFieldUpdate1773394091289 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`slc_item_catalog\` CHANGE \`programming_language\` \`programming_language\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`slc_item_catalog\` CHANGE \`natural_language\` \`natural_language\` text NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`slc_item_catalog\` CHANGE \`natural_language\` \`natural_language\` text NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`slc_item_catalog\` CHANGE \`programming_language\` \`programming_language\` text NOT NULL`);
